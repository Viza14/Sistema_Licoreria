...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul style="background-color: var(--purple);" class="  navbar-nav sidenav-not-toggled sidebar sidebar-dark accordion   " id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/licoreria/inicio.php">
            ...
            <li class="nav-item active">
                <a class=" nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapsefour">
                    ...
                    <span style="font-size: large;">Vender</span>
                </a>

                <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"></h6>
                        <a class="collapse-item" href=" /licoreria/views/compra/realizarCompra.php">Realizar compra</a>
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTen" aria-expanded="true" aria-controls="collapseTen">
                    <i class="fas fa-fw fa-cog"></i>
                    <span style="font-size: large;">Inventario</span>
                </a>
                ...
                <div id="collapseTen" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=" /licoreria/views/productos/agregarProductos.php">Agregar productos</a>

                        <a class="collapse-item" href=" /licoreria/views/productos/listado.php">listado de productos</a>
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="true" aria-controls="collapseEleven">
                    <i class="fas fa-fw fa-cog"></i>
                    <span style="font-size: large;">Clientes</span>
                </a>
                ...
                <div id="collapseEleven" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href=" /licoreria/views/clientes/agregarClientes.php">Agregar clientes</a>
                        <a class="collapse-item" href=" /licoreria/views/clientes/listado.php">Listado de clientes</a>
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                    <i class="fas fa-fw fa-cog"></i>
                    <span style="font-size: large;">Ventas</span>
                </a>
                <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"></h6>

                        <a class="collapse-item" href="/licoreria/views/ventas/listado.php">Listado de ventas</a>
                        <!--       <a class="collapse-item" href="/Inspecciones/views/ubicacion/buscarUbicaciones.php">Agregar una venta</a> -->
 ...
 -->
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsefive" aria-expanded="true" aria-controls="collapsefive">
                    <i class="fas fa-fw fa-cog"></i>
                    <span style="font-size: large;">Usuarios</span>
                </a>
                <div id="collapsefive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header"></h6>
                        <a class="collapse-item" href="/licoreria/views/usuarios/nuevoUsuario.php">Nuevo Usuario</a>
                        <a class="collapse-item" href="/licoreria/views/usuarios/gestionarUsuarios.php">Gestionar Usuarios</a>
                    </div>
                </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="/licoreria/img/undraw_profile.svg">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">

                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="/licoreria/controller/cerrar.php" data-toggle="modal" data-target="#logoutModal">
